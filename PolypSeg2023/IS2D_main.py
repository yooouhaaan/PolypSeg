...
from IS2D_Experiment.AIHub_forest_type_segmentation_experiment import AIHubForestTypeSegmentationExperiment
...
def IS2D_main(args) :
    ...
    if args.data_type in ['CVC-ClinicDB', 'Kvasir-SEG'] :
        args.image_size = 256
        args.num_channels = 3
        args.num_classes = 1
    elif args.data_type == 'Forest_Type_Segmentation':
        args.image_size = 512
        args.num_channels = 3
        args.num_classes = 6
    ...
    if args.multiprocessing_distributed and args.train:
        ...
        if args.data_type in ['CVC-ClinicDB', 'Kvasir-SEG', 'BKAI-IGH-NeoPolyp'] : experiment = ImageSegmentationExperiment(args)
        elif args.data_type == 'Forest_Type_Segmentation': experiment = AIHubForestTypeSegmentationExperiment(args)
...
if __name__=='__main__' :
    ...
    # /media/jhnam0514/68334fe0-2b83-45d6-98e3-76904bf08127/home/namjuhyeon/Desktop/LAB/common material/Dataset Collection
    ...
    parser.add_argument('--data_type', type=str, required=True, choices=['CVC-ClinicDB', 'Kvasir-SEG', # Polyp Image Semantic Segmentation Dataset
                                                                         'Forest_Type_Segmentation'])               # Satellite Forest Type Segmentation Dataset
    parser.add_argument('--model_name', type=str, required=True, choices=['FCN', 'UNet', 'UNet++', 'DeepLabV3+', 'FrequencyUNet'])
